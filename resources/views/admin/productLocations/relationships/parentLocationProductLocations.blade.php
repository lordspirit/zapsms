...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-parentLocationProductLocations">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.productLocation.fields.parent_location') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($productLocations as $key => $productLocation)
                        <tr data-entry-id="{{ $productLocation->id }}">
                            ...
                            <td>
                                {{ $productLocation->parent_location->name ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-parentLocationProductLocations:not(.ajaxTable)').DataTable({ buttons: dtButtons })
