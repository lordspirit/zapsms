...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ProductTag">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ProductTag').DataTable(dtOverrideGlobals);
