...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-subcategoryProductCategories">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($productCategories as $key => $productCategory)
                        <tr data-entry-id="{{ $productCategory->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $productCategory->active ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-subcategoryProductCategories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
